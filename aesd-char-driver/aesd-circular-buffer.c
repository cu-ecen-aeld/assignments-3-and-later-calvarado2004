            ...
            size_t char_offset, size_t *entry_offset_byte_rtn )
{
    ...
    do {
        ...
        // Check if current entry contains the char_offset
        ...
        // If the buffer is not full and we've caught up to in_offs, stop
...
/**
* Adds entry @param add_entry to @param buffer in the location specified by buffer->in_offs.
...
/**
* Initializes the circular buffer described by @param buffer to an empty state.
*/
